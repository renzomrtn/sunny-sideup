...
Exchange layout
───────────────
  Exchange : macasinag.events   (topic, durable)
  Routing keys:
    account.created
    account.updated
    account.deactivated
...
Queues (durable, bound to macasinag.events)
────────────────────────────────────────
  macasinag.audit     – receives  #            (every event)
  macasinag.eventing  – receives  account.*   (domain events only)
"""
...
EXCHANGE_NAME = "macasinag.events"
AUDIT_QUEUE   = "macasinag.audit"
EVENTING_QUEUE = "macasinag.eventing"
